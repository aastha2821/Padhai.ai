...
import { Upload, Search, CreditCard, FileText, Package, MoreVertical, Telescope } from "lucide-react"
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <Link
          ...
          className="btn-3d-orange px-6 py-3 rounded-full font-semibold inline-block text-center flex items-center gap-2"
        >
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-2">
              <Link
                ...
                className="btn-3d-orange-secondary px-4 py-2 rounded-lg text-sm text-center font-medium flex items-center justify-center gap-1"
              >
      ...
      {filteredDocuments.length === 0 && (
        <div className="dark-card p-12 rounded-xl text-center">
          <Telescope className="w-16 h-16 mx-auto mb-4 text-gray-500" />
          ...
          {!searchQuery && (
            <Link
              href="/dashboard/upload"
              className="btn-3d-orange px-6 py-3 rounded-full font-semibold inline-flex items-center gap-2"
            >
