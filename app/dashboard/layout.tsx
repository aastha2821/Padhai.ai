          ...
          <div className="flex items-center gap-3">
            <Button 
              ...
              className={`px-5 h-10 rounded-full font-opendyslexic border-white/20 hover:bg-white/10 transition-all ${
                isDyslexicMode ? 'bg-purple-500/20 border-purple-500/50' : 'dyslexic-button-blink border-red-500/30'
              }`}
            >
              <span className={!isDyslexicMode ? 'animate-pulse' : ''}>
                {isDyslexicMode ? '✓ ' : '⚠️ '}Dyslexic Mode
              </span>
            </Button>
