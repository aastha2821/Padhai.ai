        ...
        <div className="w-full max-w-none px-4 sm:px-6 md:px-8 lg:px-0 lg:max-w-[1060px] lg:w-[1060px] relative flex flex-col justify-start items-start min-h-screen">
          ...
          <div className="self-stretch pt-[9px] overflow-hidden border-b border-[rgba(55,50,47,0.06)] flex flex-col justify-center items-center gap-4 sm:gap-6 md:gap-8 lg:gap-[66px] relative z-10">
            ...
            <div className="w-full h-12 sm:h-14 md:h-16 lg:h-[84px] absolute left-0 top-0 flex justify-center items-center z-20 px-6 sm:px-8 md:px-12 lg:px-0">
              ...
              <div className="w-full max-w-[calc(100%-32px)] sm:max-w-[calc(100%-48px)] md:max-w-[calc(100%-64px)] lg:max-w-[700px] lg:w-[700px] h-10 sm:h-11 md:h-12 py-1.5 sm:py-2 px-3 sm:px-4 md:px-4 pr-2 sm:pr-3 dark-card backdrop-blur-xl overflow-hidden rounded-[50px] flex justify-between items-center relative z-30">
                ...
                <div className="h-6 sm:h-7 md:h-8 flex justify-start items-start gap-2 sm:gap-3">
                  <Link
                    href="/dashboard"
                    className="px-3 sm:px-4 py-1.5 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 transition-all backdrop-blur-sm overflow-hidden rounded-full flex justify-center items-center cursor-pointer border border-white/30 shadow-lg gap-1.5"
                  >
            ...
            <div className="pt-16 sm:pt-20 md:pt-24 lg:pt-[216px] pb-8 sm:pb-12 md:pb-16 flex flex-col justify-start items-center px-2 sm:px-4 md:px-8 lg:px-0 w-full sm:pl-0 sm:pr-0 pl-0 pr-0">
              ...
              <div className="w-full max-w-[600px] flex flex-col justify-center items-center gap-4 relative z-10 mt-6 sm:mt-8 md:mt-10 lg:mt-12">
                <div className="backdrop-blur-[8.25px] flex flex-wrap justify-center items-center gap-4">
                  <Link href="/dashboard">
                    <Button className="h-12 sm:h-13 md:h-14 px-8 sm:px-10 md:px-12 rounded-full flex items-center gap-2 shadow-xl">
                  ...
                  <Link href="/dashboard">
                    <Button variant="outline" className="h-12 sm:h-13 md:h-14 px-8 sm:px-10 md:px-12 rounded-full flex items-center gap-2 border-white/30 bg-white/5 hover:bg-white/10 backdrop-blur-xl">
                      <LogIn className="w-5 h-5" />
                      <span className="text-white text-sm sm:text-base md:text-[15px] font-semibold leading-5 font-sans">Try Demo Dashboard</span>
                    </Button>
                  </Link>
                </div>
